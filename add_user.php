...
$sql_log = "INSERT into tbl_logdata values ('','$LoginTime','$userLogin','$ip','Add User')";
$result_log = $conn->query($sql_log);

$id = $_GET['id'];

$sql_info = "SELECT * FROM tbl_member,tbl_member_type,tbl_member_dep 
WHERE tbl_member.member_department = tbl_member_dep.member_dep_code and tbl_member.member_type = tbl_member_type.member_type_code ";
        ...
        <div class="card bg-info text-white text-left p-3" style="text-align: center; border-radius: 25px;">
            ...
            <div class="card-header bg-info text-white justify-content-between">
                <div class="form-inline justify-content-between">
                    ...
                    <form method="post" action="add1.php"  name="txtid" class="form-inline ">
            ...
            <!-- body -->
                <table class="table table-borderless text-white">
                    <tbody>
                        ...
                        <th scope="row">
                            <label class="form-label mr-sm-2" for="inlineFormCheck">
                                ...
                                <input type="text" class="form-control" name="txtmember_name" value="">
                             </th>
                            ...
                            <label class="form-label mr-sm-2" for="inlineFormCheck">
                                ...
                                <input type="text" class="form-control" name="txtmember_username" value="">
                             </th>
                            ...
                            <label class="form-label mr-sm-2" for="inlineFormCheck">
                                ...
                                <input type="text" class="form-control" name="txtmember_password" value="">
                             </th>
                             <th scope="row">
                            <label class="form-label mr-sm-2" for="inlineFormCheck">
                                E-mail : 
                                </label>
                                <input type="text" class="form-control" name="txtmember_mail" value="">
                             </th>
                        </tr>
                        <tr>
                        ...
                        <th scope="row">
                            <label class="form-label mr-sm-2" for="inlineFormCheck">
                                ...
                                <input type="text" class="form-control" name="txtmember_card_id" value="">
                             </th>
                    ...
                    <select name="txtdepcode" class="form-control" required>
                            <option value=""><?php print "กรุณาเลือกสังกัด"; ?></option>
                    ...
                    <select name="txttypecode" class="form-control" required>
                            <option value=""><?php print "กรุณาเลือกระดับ"; ?></option>
                            <?php foreach($result2 as $results){?>
                            <option value="<?php echo $results["member_type_code"];?>">
                            
                            <?php echo $results["member_type_name"]; ?>
                            </option>
                            <?php } ?>
                        </select>
