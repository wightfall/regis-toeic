        ...
        <div class="card bg-light text-dark text-left p-3" style="text-align: center; border-radius: 25px;">
            ...
            <div class="card-header bg-light text-dark">
                <div class="form-inline justify-content-between">
                   <!-- ค้นหา -->
                    <form action="admin_show.php" id="serach_data" method="post" class="form-inline">
                        ...
                        <a href="admin_show.php" class="btn btn-outline-success">Reset</a>
                    </form>
                ...
                <div class="form-inline justify-content-between">
                    <form action="admin_show.php" method="POST" class="form-inline ">
                        <!-- หน้า -->
                        ...
                        <select class="form-select mr-sm-3" onchange='location = this.value;'>
                            ...
                            print "<option value='admin_show.php?page=$i&year=$year&search=$search'>" .$i."</option>";
                            } ?>
                        </select>
                        ...
                        <select class="form-select mr-sm-5" onchange='location = this.value;'>
                            ...
                            while ($row = $result_year -> fetch_assoc()) {
                                $year = $row['year'];
                                print "<option value='admin_show.php?year=$year'>" .$year ."</option>";
                            } ?>
                        </select>
                    </form>
                    <form action="im.php" class="form-inline ">
                            ...
                            if (mysqli_num_rows($result) !=0) {
                               ...
                               while ($row = $result -> fetch_assoc()) { 
                                   ...
                                   $major_name = $row['member_dep_major']." / ".$row['member_dep_name'];
                                    ...
                                    print "</TD><TD>
                                    <a href='info_admin.php?id=$id'class='btn btn-outline-success'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-eye' viewBox='0 0 16 16'>
                                    <path d='M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z'/>
                                    <path d='M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z'/>
                                    </svg></a>
                                    </TD>";
                                    print "<TD>
                                    <a href='del_stu.php?id=$id'class='btn btn-danger'>
