...
$sql_log = "INSERT into tbl_logdata values ('','$LoginTime','$userLogin','$ip','show department')";
...
if (!isset($_GET['page'])) {
 ...
 if (!isset($_POST['txtsearch']) && !isset($_GET['search'])) {
        $sql_count = "SELECT  *  FROM  tbl_member_dep ";
        ...
        $sql_show = "SELECT  *  FROM  tbl_member_dep limit $startRec,$show_record";
...
// กรณีค้นหา get
    ...
    $search = $_GET['search'];
        ...
        $sql_show = "SELECT  *  FROM  tbl_member_dep 
        where (
        member_dep_code like '%$search%'
        or member_dep_name like '%$search%'
        or member_dep_major like '%$search%'
        ...
        <div class="card bg-light text-dark text-left p-3" style="text-align: center; border-radius: 25px;">
            ...
            <div class="card-header bg-light text-dark">
                <div class="form-inline justify-content-between">
                   <!-- ค้นหา -->
                    <form action="dep.php" id="serach_data" method="post" class="form-inline">
                        ...
                        <a href="dep.php" class="btn btn-outline-success">Reset</a>
                    </form>

                    <!-- PDF -->
                    <form action="#" method="post" class="form-inline ">
                        <label class="form-label mr-sm-2" >
                            จำนวนสาขา ทั้งหมด  :: <?php print $total_records; ?>
                        </label>
                ...
                <div class="form-inline justify-content-between">
                    <form action="" class="form-inline ">
                        ...
                        <select class="form-select" onchange='location = this.value;'>
                            ...
                            print "<option value='dep.php?page=$i&search=$search'>" .$i ."</option>";
                            } ?>
                        </select>
                    </form>
                    <!-- <form action="" class="form-inline "> -->
